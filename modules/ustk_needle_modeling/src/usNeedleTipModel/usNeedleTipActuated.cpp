...
{
    return new usNeedleTipActuated(*this);
}
...
{
    return 180/M_PI*_steeringAngle;
}
...
{
    vpHomogeneousMatrix H(_length*cos(_steeringAngle)*sin(_angle), \
                          _length*sin(_steeringAngle)*sin(_angle), \
                          _length*cos(_angle), \
                          -_angle*sin(_steeringAngle), \
                          _angle*cos(_steeringAngle), \
                          0);
