...
int main()
{
  ...
  points2D.at(0)[0] = 0.02;
  points2D.at(0)[1] = 0.02;
  points2D.at(1)[0] = 0.02;
  points2D.at(1)[1] = 0.03;
  points2D.at(2)[0] = 0.03;
  points2D.at(2)[1] = 0.03;
  points2D.at(3)[0] = 0.02;
  points2D.at(3)[1] = 0.05;
  ...
  std::cout << "done: usGeometryDisplayTools::display(const usOrientedPlane3D&, vpImage<unsigned char>&, const "
               "vpHomogeneousMatrix&, double, double, const vpColor&);"
            << std::endl;
  usGeometryDisplayTools::display(plane, I2, imageMworld, 3000, 3000, vpColor::green);
  std::cout << "done: usGeometryDisplayTools::display(const usOrientedPlane3D&, vpImage<vpRGBa>&, const "
               "vpHomogeneousMatrix&, double, double, const vpColor&);"
            << std::endl;

  usGeometryDisplayTools::display(curve2D, I1, 3000, 3000, vpColor::red, 10);
  std::cout << "done: usGeometryDisplayTools::display(const usPolynomialCurve2D&, vpImage<unsigned char>&, double, "
               "double, const vpColor&);"
            << std::endl;
  usGeometryDisplayTools::display(curve2D, I2, 3000, 3000, vpColor::red, 10);
  std::cout << "done: usGeometryDisplayTools::display(const usPolynomialCurve2D&, vpImage<vpRGBa>&, double, double, "
               "const vpColor&);"
            << std::endl;

  usGeometryDisplayTools::display(curve3D, I1, imageMworld, 3000, 3000, vpColor::blue, 10,
                                  std::numeric_limits<double>::infinity());
  std::cout << "done: usGeometryDisplayTools::display(const usPolynomialCurve3D&, vpImage<unsigned char>&, const "
               "vpHomogeneousMatrix&, double, double, const vpColor&, int, double);"
            << std::endl;
  usGeometryDisplayTools::display(curve3D, I2, imageMworld, 3000, 3000, vpColor::blue, 10,
                                  std::numeric_limits<double>::infinity());
  std::cout << "done: usGeometryDisplayTools::display(const usPolynomialCurve3D&, vpImage<vpRGBa>&, const "
               "vpHomogeneousMatrix&, double, double, const vpColor&, int, double);"
            << std::endl;

  usGeometryDisplayTools::displayLine(spline, I1, imageMworld, 3000, 3000, vpColor::orange, 10,
                                      std::numeric_limits<double>::infinity());
  std::cout << "done: usGeometryDisplayTools::displayLine(const usBSpline3D&, vpImage<unsigned char>&, const "
               "vpHomogeneousMatrix&, double, double, const vpColor&, int, double);"
            << std::endl;
  usGeometryDisplayTools::displayLine(spline, I2, imageMworld, 3000, 3000, vpColor::orange, 10,
                                      std::numeric_limits<double>::infinity());
  std::cout << "done: usGeometryDisplayTools::displayLine(const usBSpline3D&, vpImage<vpRGBa>&, const "
               "vpHomogeneousMatrix&, double, double, const vpColor&, int, double);"
            << std::endl;

  usGeometryDisplayTools::displayExtremities(spline, I1, imageMworld, 3000, 3000, vpColor::orange,
                                             std::numeric_limits<double>::infinity());
  std::cout << "done: usGeometryDisplayTools::displayExtremities(const usBSpline3D&, vpImage<unsigned char>&, const "
               "vpHomogeneousMatrix&, double, double, const vpColor&, double);"
            << std::endl;
  usGeometryDisplayTools::displayExtremities(spline, I2, imageMworld, 3000, 3000, vpColor::orange,
                                             std::numeric_limits<double>::infinity());
  std::cout << "done: usGeometryDisplayTools::displayExtremities(const usBSpline3D&, vpImage<vpRGBa>&, const "
               "vpHomogeneousMatrix&, double, double, const vpColor&, double);"
            << std::endl;

  usGeometryDisplayTools::displayCurvatureFromShape(spline, I1, imageMworld, 3000, 3000, vpColor::orange);
  std::cout << "done: usGeometryDisplayTools::displayCurvatureFromShape(const usBSpline3D&, vpImage<unsigned char>&, "
  ...
  std::cout << "done: usGeometryDisplayTools::displayCurvatureFromShape(const usBSpline3D&, vpImage<vpRGBa>&, const "
               "vpHomogeneousMatrix&, double, double, const vpColor&);"
            << std::endl;
