...
template VISP_EXPORT void displayFrame<unsigned char>(const vpImage<unsigned char> &, const vpHomogeneousMatrix &,
                                                      double, double);
...
template <class ImageDataType>
void display(const usOrientedPlane3D &plane, const vpImage<ImageDataType> &I, const vpHomogeneousMatrix &imageMworld,
             double Xscale, double Yscale, const vpColor &color)
{
...
template VISP_EXPORT void display(const usOrientedPlane3D &, const vpImage<vpRGBa> &, const vpHomogeneousMatrix &,
                                  double, double, const vpColor &);

//! Display usPolynomialCurve2D

template <class ImageDataType>
void display(const usPolynomialCurve2D &curve, const vpImage<ImageDataType> &I, double Xscale, double Yscale,
             const vpColor &color, int nbRenderingLines)
{
...
template VISP_EXPORT void display<unsigned char>(const usPolynomialCurve2D &, const vpImage<unsigned char> &, double,
                                                 double, const vpColor &, int);
template VISP_EXPORT void display<vpRGBa>(const usPolynomialCurve2D &, const vpImage<vpRGBa> &, double, double,
                                          const vpColor &, int);

//! Display usPolynomialCurve3D

template <class ImageDataType>
void display(const usPolynomialCurve3D &curve, const vpImage<ImageDataType> &I, const vpHomogeneousMatrix &imageMworld,
             double Xscale, double Yscale, const vpColor &color, int nbRenderingLines, double visibilityDistance)
{
...
template VISP_EXPORT void display<unsigned char>(const usPolynomialCurve3D &, const vpImage<unsigned char> &,
                                                 const vpHomogeneousMatrix &, double, double, const vpColor &, int,
                                                 double);
template VISP_EXPORT void display<vpRGBa>(const usPolynomialCurve3D &, const vpImage<vpRGBa> &,
                                          const vpHomogeneousMatrix &, double, double, const vpColor &, int, double);

template <class ImageDataType>
void displayCurvatureFromShape(const usPolynomialCurve3D &curve, const vpImage<ImageDataType> &I,
...
template VISP_EXPORT void displayCurvatureFromShape<unsigned char>(const usPolynomialCurve3D &,
                                                                   const vpImage<unsigned char> &,
                                                                   const vpHomogeneousMatrix &, double, double,
                                                                   const vpColor &);
template VISP_EXPORT void displayCurvatureFromShape<vpRGBa>(const usPolynomialCurve3D &, const vpImage<vpRGBa> &,
                                                            const vpHomogeneousMatrix &, double, double,
                                                            const vpColor &);
...
template <class ImageDataType>
void displayLine(const usBSpline3D &spline, const vpImage<ImageDataType> &I, const vpHomogeneousMatrix &imageMworld,
                 double Xscale, double Yscale, const vpColor &color, int nbRenderingLinesPerSegment,
                 double visibilityDistance)
{
  for (int i = 0; i < spline.getNbSegments(); i++)
    usGeometryDisplayTools::display(spline.accessSegment(i), I, imageMworld, Xscale, Yscale, color,
                                    nbRenderingLinesPerSegment, visibilityDistance);
}
template VISP_EXPORT void displayLine<unsigned char>(const usBSpline3D &, const vpImage<unsigned char> &,
                                                     const vpHomogeneousMatrix &, double, double, const vpColor &, int,
                                                     double);
template VISP_EXPORT void displayLine<vpRGBa>(const usBSpline3D &, const vpImage<vpRGBa> &, const vpHomogeneousMatrix &,
                                              double, double, const vpColor &, int, double);

template <class ImageDataType>
void displayExtremities(const usBSpline3D &spline, const vpImage<ImageDataType> &I,
                        const vpHomogeneousMatrix &imageMworld, double Xscale, double Yscale, const vpColor &color,
                        double visibilityDistance)
{
  ...
  for (int i = 0; i < spline.getNbSegments(); i++)
    points.insert(spline.accessSegment(i).getStartPoint(), 0, i);
...
template VISP_EXPORT void displayExtremities<unsigned char>(const usBSpline3D &, const vpImage<unsigned char> &,
                                                            const vpHomogeneousMatrix &, double, double,
                                                            const vpColor &, double);
template VISP_EXPORT void displayExtremities<vpRGBa>(const usBSpline3D &, const vpImage<vpRGBa> &,
                                                     const vpHomogeneousMatrix &, double, double, const vpColor &,
                                                     double);

template <class ImageDataType>
void display(const usBSpline3D &spline, const vpImage<ImageDataType> &I, const vpHomogeneousMatrix &imageMworld,
             double Xscale, double Yscale, const vpColor &color, int nbRenderingLines, double visibilityDistance)
{
...
template VISP_EXPORT void display<unsigned char>(const usBSpline3D &, const vpImage<unsigned char> &,
                                                 const vpHomogeneousMatrix &, double, double, const vpColor &, int,
                                                 double);
template VISP_EXPORT void display<vpRGBa>(const usBSpline3D &, const vpImage<vpRGBa> &, const vpHomogeneousMatrix &,
                                          double, double, const vpColor &, int, double);

template <class ImageDataType>
void displayCurvatureFromShape(const usBSpline3D &spline, const vpImage<ImageDataType> &I,
                               const vpHomogeneousMatrix &imageMworld, double Xscale, double Yscale,
                               const vpColor &color)
{
  vpColVector C(4);
...
template VISP_EXPORT void displayCurvatureFromShape<unsigned char>(const usBSpline3D &, const vpImage<unsigned char> &,
                                                                   const vpHomogeneousMatrix &, double, double,
                                                                   const vpColor &);
template VISP_EXPORT void displayCurvatureFromShape<vpRGBa>(const usBSpline3D &, const vpImage<vpRGBa> &,
                                                            const vpHomogeneousMatrix &, double, double,
                                                            const vpColor &);
