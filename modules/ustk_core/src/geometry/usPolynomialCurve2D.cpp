...
void usPolynomialCurve2D::setStartParameter(double startParameter) { m_startParameter = startParameter; }

double usPolynomialCurve2D::getStartParameter() const { return m_startParameter; }

void usPolynomialCurve2D::setEndParameter(double endParameter) { m_endParameter = endParameter; }

double usPolynomialCurve2D::getEndParameter() const { return m_endParameter; }
...
void usPolynomialCurve2D::setParametricLength(double length) { m_endParameter = m_startParameter + length; }

double usPolynomialCurve2D::getParametricLength() const { return m_endParameter - m_startParameter; }

void usPolynomialCurve2D::setLength(double length, double precision)
{
  if (precision <= 0)
    throw vpException(vpException::badValue, "usPolynomialCurve2D::setLength: precision should be strictly positive");
  if (length <= 0)
    throw vpException(vpException::badValue, "usPolynomialCurve2D::setLength: length should be strictly positive");
...
void usPolynomialCurve2D::setPolynomialCoefficients(const vpMatrix &polynomialCoefficients)
{
  if (polynomialCoefficients.getCols() < 2)
    throw vpException(vpException::dimensionError,
                      "usPolynomialCurve2D::setPolynomialCoefficients: empty coefficient matrix");
  if (polynomialCoefficients.getRows() != 2)
    throw vpException(vpException::dimensionError,
                      "usPolynomialCurve2D::setPolynomialCoefficients: space dimension should be 2");

  m_order = polynomialCoefficients.getCols() - 1;
  m_polynomialCoefficients = polynomialCoefficients;
}

vpMatrix usPolynomialCurve2D::getPolynomialCoefficients() const { return m_polynomialCoefficients; }
...
vpColVector usPolynomialCurve2D::getStartPoint() const { return this->getPoint(m_startParameter); }

vpColVector usPolynomialCurve2D::getEndPoint() const { return this->getPoint(m_endParameter); }
...
vpColVector usPolynomialCurve2D::getStartTangent() const { return this->getTangent(m_startParameter); }

vpColVector usPolynomialCurve2D::getEndTangent() const { return this->getTangent(m_endParameter); }
...
void usPolynomialCurve2D::defineFromPoints(const std::vector<vpColVector> &points, const std::vector<double> &param,
                                           unsigned int order)
{
  unsigned int nbPoints = points.size();
  if (nbPoints < 2)
    throw vpException(vpException::dimensionError, "usPolynomialCurve2D::defineFromPoints(const "
...
void usPolynomialCurve2D::defineFromPointsAuto(const std::vector<vpColVector> &points, unsigned int order)
{
  unsigned int nbPoints = points.size();
  if (nbPoints < 2)
    throw vpException(vpException::dimensionError, "usPolynomialCurve2D::defineFromPointsAuto(const "
...
void usPolynomialCurve2D::defineFromPointsAuto(const vpMatrix &points, unsigned int order)
{
  unsigned int nbPoints = points.getCols();
  if (nbPoints < 2)
    throw vpException(vpException::dimensionError, "usPolynomialCurve2D::defineFromPointsAuto(const vpMatrix &points, "
...
void usPolynomialCurve2D::defineFromPointsAuto(const std::vector<vpColVector> &points, const vpColVector &direction,
                                               unsigned int order)
{
  unsigned int nbPoints = points.size();
  if (nbPoints < 2)
                                                   ...
                                                   unsigned int order)
{
  unsigned int nbPoints = points.size();
  if (nbPoints < 2)
    throw vpException(vpException::dimensionError, "usPolynomialCurve2D::defineFromWeightedPoints(const "
                                                   "std::vector<vpColVector> &points, const std::vector<double> "
...
void usPolynomialCurve2D::defineFromWeightedPoints(const vpMatrix &points, const vpColVector &param,
                                                   const vpColVector &weights, unsigned int order)
{
  unsigned int nbPoints = points.getCols();
  if (nbPoints < 2)
    throw vpException(vpException::dimensionError, "usPolynomialCurve2D::defineFromWeightedPoints(const vpMatrix "
                                                       ...
                                                       const std::vector<double> &weights, unsigned int order)
{
  unsigned int nbPoints = points.size();
  if (nbPoints < 2)
    throw vpException(vpException::dimensionError, "usPolynomialCurve2D::defineFromWeightedPointsAuto(const "
                                                   "std::vector<vpColVector> &points, const std::vector<double> "
                                                   "&weights, unsigned int order): need at least two points to fit");
  if (weights.size() != nbPoints)
    throw vpException(vpException::dimensionError,
                      "usPolynomialCurve2D::defineFromWeightedPointsAuto(const std::vector<vpColVector> &points, const "
...
void usPolynomialCurve2D::defineFromWeightedPointsAuto(const vpMatrix &points, const vpColVector &weights,
                                                       unsigned int order)
{
  unsigned int nbPoints = points.getCols();
  if (nbPoints < 2)
    throw vpException(vpException::dimensionError, "usPolynomialCurve2D::defineFromWeightedPointsAuto(const vpMatrix "
...
{
  if (nbCountSeg < 2)
    throw vpException(vpException::badValue, "usPolynomialCurve2D::getMeanAxisDeviation: should use at least 2 segment "
...
{
  if (controlPoints.getRows() != 2)
    throw vpException(vpException::dimensionError,
                      "usPolynomialCurve2D::setControlPoints(const vpMatrix&): invalid points dimension, should be 2");
  if (controlPoints.getCols() < 2)
    throw vpException(
        vpException::dimensionError,
        "usPolynomialCurve2D::setControlPoints(const vpMatrix&): invalid number of points, should greater than 1");
...
void usPolynomialCurve2D::changeCoefficientsToFitBoundaries(double startParameter, double endParameter)
{
  if (startParameter == m_startParameter && endParameter == m_endParameter)
    return;
  if (startParameter == endParameter)
    throw vpException(vpException::dimensionError, "usPolynomialCurve2D::changeCoefficientsToFitBoundaries(double "
...
void usPolynomialCurve2D::reverse() { this->changeCoefficientsToFitBoundaries(m_endParameter, m_startParameter); }
...
void usPolynomialCurve2D::scale(double s) { m_polynomialCoefficients = s * m_polynomialCoefficients; }
...
std::istream &operator>>(std::istream &s, usPolynomialCurve2D &seg)
{
  ...
  if (c != "usPolynomialCurve2D") {
    vpException e(vpException::ioError,
                  "operator>>(std::istream&, Polynomial2D&): Stream does not contain usPolynomialCurve2D data");
    throw e;
  }
  s >> seg.m_order;
