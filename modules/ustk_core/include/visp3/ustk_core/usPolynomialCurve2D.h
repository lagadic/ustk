...
public:
   ...
   * If the starting value is higher than the ending value, these values are inverted as well as the direction of
   ...
   */
  VISP_NAMESPACE_ADDRESSING vpMatrix getPoints(VISP_NAMESPACE_ADDRESSING vpColVector parameters) const;
   ...
   * Parametric values for the different points are automatically computed according to their position along a given
   * straight direction.
   *
   * @param points The desired control points.
  ...
  */
  ...
  /**
   * Modify the polynomial coefficients such that the parametric variable now goes from two different boundaries,
   * without changing the shape of the curve in space.
   */
