...
*/
usNetworkViewerPostScan::usNetworkViewerPostScan(int frameWith, int frameHeight, QObject *parent) :
  QObject(parent)
{
...
* Destructor.
*/
usNetworkViewerPostScan::~usNetworkViewerPostScan()
{
...
*/
void usNetworkViewerPostScan::updateDisplay(usImagePostScan2D<unsigned char>* newFrame) {
