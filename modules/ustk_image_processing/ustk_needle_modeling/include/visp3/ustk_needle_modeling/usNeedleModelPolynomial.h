...
public:
    ...
    //! Data saving
        ...
        //! Text
        friend std::ostream &operator<<(std::ostream &s, const usNeedleModelPolynomial &needle);
        friend std::istream &operator>>(std::istream &s, usNeedleModelPolynomial &needle);
        //! Binary
        friend std::ostream &operator<<=(std::ostream &s, const usNeedleModelPolynomial &needle);
        friend std::istream &operator>>=(std::istream &s, usNeedleModelPolynomial &needle);
};
